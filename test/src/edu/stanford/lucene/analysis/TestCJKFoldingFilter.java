...
//	/**
//	 * from email from Zhaohui Xue to Naomi 10-04-2013
//	 */
//@Test
//	public void testChineseVariants() throws Exception
//	{
//		checkOneTerm(analyzer, "研", "硏"); // 研 7814 => (硏) 784F
//		checkOneTerm(analyzer, "緖", "绪"); // 緖 7DD6  => (绪) 7EEA
//	}
//
//
//	/**
...
//	{
//		checkOneTerm(analyzer, "＜", "<"); // ＜ FF1C => (<) 003C Japanese
//		checkOneTerm(analyzer, "『", "「"); //『  300E => (「) 300C Japanese
//		checkOneTerm(analyzer, "』", "」"); // 』 300F => (」) 300D Japanese
//		checkOneTerm(analyzer, "戸", "戶"); // 戸 6238 => (戶) 6236 Japanese
//		checkOneTerm(analyzer, "脱", "脫"); // 脱 8131 => (脫) 812B Japanese
//		checkOneTerm(analyzer, "昒", "〓"); // 昒 6612 => (〓) Japanese
//		checkOneTerm(analyzer, "晩", "晚"); // 晩 6669 => (만) 665A  Korean
//		checkOneTerm(analyzer, "歳", "歲"); // 歳 6B73 => (歲) 6B72 Japanese
//		checkOneTerm(analyzer, "圏", "圈"); // 圏 570F => (圈) 5708 Japanese
//		checkOneTerm(analyzer, "閲", "閱"); // 閲 95B2 => (閱) 95B1 Japanese
//		checkOneTerm(analyzer, "髙", "高"); // 髙 9AD9 => (高) 9AD8 Japanese
//		checkOneTerm(analyzer, "ﾑ", "ム"); // ﾑ FF91 => (ム) 30E0 Japanese
//		checkOneTerm(analyzer, "ｳ", "ウ"); // ｳ FF73 => (ウ) 30A6 Japanese
//		checkOneTerm(analyzer, "尙", "尚"); // 尙 5C19 => (尚) 5C1A Korean
//		checkOneTerm(analyzer, "０", "〇"); // ０ FF10 => (〇) 3007
//		checkOneTerm(analyzer, "沨", "渢"); // 沨 6CA8 => (渢) 6E22 Chinese
//		checkOneTerm(analyzer, "戱", "戯"); // 戱 6231 => (戯) 622F Korean
//		checkOneTerm(analyzer, "刪", "删"); // 刪 522A => (删) 5220 Chinese
//		checkOneTerm(analyzer, "", ""); // 2010 => () 002D
//		checkOneTerm(analyzer, "繋", "繫"); // 繋 7E4B => (繫) 7E6B Japanese
//		checkOneTerm(analyzer, "亷", "廉"); // 亷 4EB7 => (廉) 5EC9 Japanese
//		checkOneTerm(analyzer, "｢", "「"); // ｢ FF62 => (「) 300C Japanese
//		checkOneTerm(analyzer, "｣", "」"); // ｣ FF63 => (」) 300D Japanese
//		checkOneTerm(analyzer, "兩", "兩"); // 兩 F978 => (兩) 5169 Korean
//		checkOneTerm(analyzer, "隸", "隷"); // 隸 F9B8 => (隷) 96B7 Korean
//		checkOneTerm(analyzer, "隣", "隣"); // 隣 F9F1 => (隣) 96A3 Korean
//		checkOneTerm(analyzer, "晴", "晴"); // 晴 FA12 => (晴) 6674 Korean
//		checkOneTerm(analyzer, "靖", "靖"); // 靖 FA1C => (靖) 9756 Korean
//		checkOneTerm(analyzer, "精", "精"); // 精 FA1D => (精) 7CBE Korean
//		checkOneTerm(analyzer, "逸", "逸"); // 逸 FA25 => (逸) 9038 Korean
//		checkOneTerm(analyzer, "裵", ""); // 裵 88F5 => () Korean
//		checkOneTerm(analyzer, "訷", "〓"); // 訷 8A37 => (〓) Japanese
//		checkOneTerm(analyzer, "鋭", "銳"); // 鋭 92ED => (銳) 92B3 Chinese
//		checkOneTerm(analyzer, "騨", "驒"); // 騨 9A28 => (驒) 9A52 Japanese
//		checkOneTerm(analyzer, "昻", "昂"); // 昻 663B => (昂) 6602 Japanese
//		checkOneTerm(analyzer, "ヸ", ""); // ヸ 30F8 => (〓) Japanese
//		checkOneTerm(analyzer, "큉", "〓"); // 큉 D049 => () Korean
//		checkOneTerm(analyzer, "闗", "關"); // 闗 95D7 => (關) 95DC Chinese
//		checkOneTerm(analyzer, "", ""); // 6FF5 => () 6FF1 Chinese
//		checkOneTerm(analyzer, "兀", "兀"); // 兀 FA0C => (兀) 5140
//		checkOneTerm(analyzer, "不", "不"); // 不 F967 => (不) 4E0D Korean
//		checkOneTerm(analyzer, "串", "串"); // 串 F905 => (串) 4E32 Korean
//		checkOneTerm(analyzer, "丹", "丹"); // 丹 F95E => (丹) 4E39 Korean
